...
class RecyclerComida : AppCompatActivity() {
        ...
        miAdapter = AdaptadorComida(
            ...
            object : AdaptadorComida.OnItemClickListener {
                override fun onItemClick(name: String?, position: Int) {
                    val  alert = AlertDialog.Builder(this@RecyclerComida)
                    ...
                    alert.setNegativeButton("No"){_,_->
                        Toast.makeText(this@RecyclerComida, "Operación abortada",Toast.LENGTH_LONG).show()
                    }
                    alert.setNeutralButton("Cancelar"){_,_->
                        Toast.makeText(this@RecyclerComida, "Operación cancelada",Toast.LENGTH_LONG).show()
                    }
    ...
    private fun actualizarListaYAdaptador(nombreGasto: String) {
        val listaGastos = (miRecyclerView.adapter as AdaptadorComida).dato
